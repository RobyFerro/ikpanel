...
/******/({
	...
	/***/ "./src/Modules/blog/resources/assets/js/components/articles/new.ts":
	/*!*************************************************************************!*\
	  !*** ./src/Modules/blog/resources/assets/js/components/articles/new.ts ***!
	  \*************************************************************************/
		...
		$(function() {
			...
			body.on('click', '.action-save', function() {
				...
				$.ajax({
					...
					beforeSend: function() {
						modern_gui_1.default.loading(true, 'Salvataggio articolo in corso...');
					},
	...
	/***/ (function(module, exports, __webpack_require__) {
		...
		module.exports = __webpack_require__(/*! C:\Users\roberto.ferro\PhpstormProjects\OmniGarden\packages\ikdev\ikpanel\src\Modules\blog\resources\assets\js\components\articles\new.ts */"./src/Modules/blog/resources/assets/js/components/articles/new.ts");
