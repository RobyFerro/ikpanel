...
/***/ "./src/Modules/blog/resources/assets/js/components/articles/edit.ts":
/*!**************************************************************************!*\
  !*** ./src/Modules/blog/resources/assets/js/components/articles/edit.ts ***!
  \**************************************************************************/
...
$(function () {
    ...
    body.on('click', '.action-save', function () {
        ...
        $.ajax({
            ...
            beforeSend: function () {
                modern_gui_1.default.loading(true, 'Modifica articolo in corso');
            },
            success: function () {
                switch (action) {
                    case 'close':
    ...
    body.on('click', '#deleteArticles', function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, modern_gui_1.default.confirm('Sei sicuro di voler eliminare questo articolo?')];
                    case 1:
                        if (_a.sent()) {
                            $.ajax({
                                type: 'DELETE',
                                ...
                                beforeSend: function () {
                                    modern_gui_1.default.loading(true, 'Eliminazione articolo in corso...');
                                },
                                success: function () {
    ...
    fileReader.onload = function (e) {
        var mainPic = $('#main-pic-preview'), mainPicWidth = mainPic.width();
        // @ts-ignore
...
module.exports = __webpack_require__(/*! C:\Users\roberto.ferro\PhpstormProjects\ikpanel\packages\ikdev\ikpanel\src\Modules\blog\resources\assets\js\components\articles\edit.ts */"./src/Modules/blog/resources/assets/js/components/articles/edit.ts");
