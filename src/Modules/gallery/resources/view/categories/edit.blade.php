...
@section('title')
	{{ __('ikpanel-gallery::gallery.categories.edit.title') }} - {{ $category->name }}
@endsection

@section('section_name')
	{{ __('ikpanel-gallery::gallery.categories.edit.sectionName') }} - {{ $category->name }}
@endsection
	...
	<div class="row">
		<div class="col-md-12">
			<div class="form-group form-group-default required">
				<label for="name">
					{{ __('ikpanel-gallery::gallery.categories.edit.inputs.categoryName') }}
				</label>
	...
	<div class="row">
			...
			<div class="card">
				<div class="card-header">
					<div class="card-title">
						{{ __('ikpanel-gallery::gallery.categories.edit.inputs.categoryDescription') }}
					</div>
				</div>
				<div class="card-body">
		...
		<div class="col-md-3">
			<div class="card">
				<div class="card-header">
					<div class="card-title">
						{{ __('ikpanel-gallery::gallery.categories.edit.inputs.keywordsDescription') }}
					</div>
				</div>
				<div class="card-body">
			...
			<div class="card">
				<div class="card-body">
					<button class="btn btn-block btn-danger" id="deleteCategory" data-id="{{ $category->id }}">
						...
						{{ __('ikpanel-gallery::gallery.categories.edit.buttons.delete') }}
					</button>
				</div>
			</div>
		</div>
...
@section('final_script')
	...
	{!! script('ikpanel/modules/gallery/js/category/edit.js',true) !!}
@endsection
