...
/******/({
	...
	/***/ "./src/Modules/gallery/resources/assets/js/components/images/edit.ts":
	/*!***************************************************************************!*\
	  !*** ./src/Modules/gallery/resources/assets/js/components/images/edit.ts ***!
	  \***************************************************************************/
			...
			body.on('click', '#deleteArticles', function() {
				return __awaiter(this, void 0, void 0, function() {
					return __generator(this, function(_a) {
						switch(_a.label) {
							case 0:
								return [4 /*yield*/, modern_gui_1.default.confirm('Sei sicuro di voler eliminare questa immagine?')];
							case 1:
								if(_a.sent()) {
									$.ajax({
										type: 'DELETE',
	...
	/***/ 9:
	/*!*********************************************************************************!*\
	  !*** multi ./src/Modules/gallery/resources/assets/js/components/images/edit.ts ***!
	  \*********************************************************************************/
	/*! no static exports found */
	/***/ (function(module, exports, __webpack_require__) {
		
		module.exports = __webpack_require__(/*! C:\Users\roberto.ferro\PhpstormProjects\OmniGarden\packages\ikdev\ikpanel\src\Modules\gallery\resources\assets\js\components\images\edit.ts */"./src/Modules/gallery/resources/assets/js/components/images/edit.ts");
