...
class IkpanelServiceProvider extends ServiceProvider
{
    ...
    /**
     * Load ikpanel blog module
     * @return void
     */
    private function loadBlogModule()
    {
    ...
    /**
     * Load ikpanel gallery module
     * @return void
     */
    private function loadGalleryModule()
    {
    ...
    /**
     * Load ikpanel calendar module
     * @return void
     */
    private function loadCalendarModule()
    {
