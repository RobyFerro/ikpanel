...
<head>
	...
	<link class="main-stylesheet" href="{{asset('ikpanel/pages/css/themes/corporate.css')}}" rel="stylesheet"
	      type="text/css"/>
</head>
<body class="fixed-header menu-pin menu-behind">
				...
				<div class="view-port clearfix" id="chat">
					<div class="view bg-white">
                        ...
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" data-src-retina="assets/img/profiles/1x.jpg"
	...
	<script src="{{ asset('ikpanel/pages/js/pages.min.js') }}" type="text/javascript"></script>
	<script src="{{ asset('ikpanel/assets/plugins/jquery-typewatch/jquery.typewatch.js')}}"></script>
