            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group form-group-default form-group-default-select2">
                                ...
                                <select id="log-type" class="full-width select2-hidden-accessible" tabindex="-1"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table id="logs"
                                   class="table table-valign table-supercondensed dataTable table-shortpadding"
                                ...
                                @foreach($logs as $i=>$log)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            @switch($log->type)
                                                @case('INFO')
                                                <span class="fa-stack" data-toggle="tooltip" title="Info"
									...
									<i class="fas fa-info fa-stack-1x fa-inverse"></i>
                                                ...
                                                @break
                                                @case('SUCCESS')
                                                <span class="fa-stack" data-toggle="tooltip" title="Dati creati"
                                                      style="font-size: 10px;">
									...
									<i class="fas fa-save fa-stack-1x fa-inverse"></i>
                                                ...
                                                @break
                                                @case('WARNING')
                                                <span class="fa-stack" data-toggle="tooltip" title="Dati modificati"
                                                      style="font-size: 10px;">
									...
									<i class="fas fa-pencil-alt fa-stack-1x fa-inverse"></i>
                                                ...
                                                @break
                                                @case('DANGER')
                                                <span class="fa-stack" data-toggle="tooltip" title="Dati eliminati"
                                                      style="font-size: 10px;">
									...
									<i class="fas fa-trash-alt fa-stack-1x fa-inverse"></i>
                                                ...
                                                @break
                                                @case('ERROR')
                                                <span class="fa-stack" data-toggle="tooltip" title="Errore"
                                                      style="font-size: 10px;">
