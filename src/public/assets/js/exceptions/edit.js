...
/***/ "./src/resources/assets/js/components/exceptions/edit.ts":
/*!***************************************************************!*\
  !*** ./src/resources/assets/js/components/exceptions/edit.ts ***!
  \***************************************************************/
...
var notify_1 = __webpack_require__(/*! @ikpanel/notify */ "./src/resources/assets/js/modules/notify.js");
$(function () {
                    ...
                    case 1:
                        if (_a.sent()) {
                            $.ajax({
                                ...
                                beforeSend: function () {
                                    modern_gui_1.default.loading(true, "Risolvo l'errore selezionato");
                                },
    ...
    body.on('click', '#delete', function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, modern_gui_1.default.confirm('Sei sicuro di voler rimuovere questo errore?')];
                    case 1:
                        if (_a.sent()) {
                            $.ajax({
                                type: 'DELETE',
                                ...
                                beforeSend: function () {
                                    modern_gui_1.default.loading(true, "Rimuovo l'errore selezionato");
                                },
                                success: function (data) {
    ...
    body.on('click', '#restore', function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, modern_gui_1.default.confirm('Sei sicuro di voler ripristinare questo errore?')];
                    case 1:
                        if (_a.sent()) {
                            $.ajax({
                                type: 'PUT',
                                ...
                                beforeSend: function () {
                                    modern_gui_1.default.loading(true, "Ripristino in corso...");
                                },
                                success: function (data) {
                                    location.reload();
                                },
