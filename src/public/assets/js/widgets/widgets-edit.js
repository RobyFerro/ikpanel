...
/******/({
	...
	/***/ "./src/resources/assets/js/modules/composer.ts":
	/*!*****************************************************!*\
	  !*** ./src/resources/assets/js/modules/composer.ts ***!
	  \*****************************************************/
	/*! no static exports found */
	/***/ (function(module, exports, __webpack_require__) {
		...
		Object.defineProperty(exports, "__esModule", {value: true});
		var form_utils_1 = __webpack_require__(/*! ./form_utils */ "./src/resources/assets/js/modules/form_utils.ts");
		var notify_1 = __webpack_require__(/*! ./notify */ "./src/resources/assets/js/modules/notify.ts");
		var utils_1 = __webpack_require__(/*! ./utils */ "./src/resources/assets/js/modules/utils.ts");
								...
								$('#modal-add-component-save').on('click', function() {
									...
									if(position.toString().length > 0 && main.isPositionValid(position)) {
										...
										if((component_data.custom_label && componentDescription.val().toString().length == 0) ||
											(!component_data.preset && component_data.type == 'SELECT' && component_options_1.filter(function(x) {
...
//endregion
	...
	/***/ "./src/resources/assets/js/modules/notify.ts":
	/*!***************************************************!*\
	  !*** ./src/resources/assets/js/modules/notify.ts ***!
	  \***************************************************/
	/*! no static exports found */
	...
	/***/ "./src/resources/assets/js/modules/utils.ts":
	/*!**************************************************!*\
	  !*** ./src/resources/assets/js/modules/utils.ts ***!
	  \**************************************************/
	/*! no static exports found */
	...
	/***/ "./src/resources/assets/js/modules/widgets/widgets_edit.ts":
	/*!*****************************************************************!*\
	  !*** ./src/resources/assets/js/modules/widgets/widgets_edit.ts ***!
	  \*****************************************************************/
	/*! no static exports found */
	/***/ (function(module, exports, __webpack_require__) {
		...
		Object.defineProperty(exports, "__esModule", {value: true});
		var composer_1 = __webpack_require__(/*! ../composer */ "./src/resources/assets/js/modules/composer.ts");
		var WidgetsEdit = /** @class */ (function(_super) {
			...
			function WidgetsEdit(role) {
				...
				_this.tabs = [
					{
						id: 'Widgets', title: 'Widgets', predicate: function(x) {
							return true;
						}
					}
				];
	...
	/***/ (function(module, exports, __webpack_require__) {
		...
		module.exports = __webpack_require__(/*! C:\Users\roberto.ferro\PhpstormProjects\OmniGarden\packages\ikdev\ikpanel\src\resources\assets\js\components\widgets\widgets-edit.ts */"./src/resources/assets/js/components/widgets/widgets-edit.ts");
